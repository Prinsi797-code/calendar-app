      ...
      try {
        ...
        if (data.items) {
          const formatted = data.items.map((item: any) => ({
            date: formatDate(item.start.date),
            name: item.summary,
          }));
          ...
          {holidays.map((holiday, index) => (
            <View key={index} style={[styles.card, { backgroundColor: colors.cardBackground }]}>
              ...
              <View style={styles.textSection}>
                ...
                <Text style={[styles.subText, { color: colors.textTertiary }]}>All-day</Text>
              </View>

              {/* Right Side Never */}
              <Text style={[styles.never, { color: colors.textTertiary }]}>Never</Text>
            </View>
          ))}
        </ScrollView>
      )}
